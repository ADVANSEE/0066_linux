...
#ifdef CAN2
	/* CAN2  */
	MX6PAD(SD3_DAT1__CAN2_RXCAN),
	MX6PAD(SD3_DAT0__CAN2_TXCAN),
	MX6PAD(SD3_DAT2__GPIO_7_6),		/* STNDBY */
#endif
...
#elif defined(CONFIG_MACH_MX6_NITROGEN6X_STERSEE6) || defined(CONFIG_MACH_MX6_NITROGEN6X_STERSEE6_LVDS)
	MX6PAD(EIM_EB2__GPIO_2_30),		/* GPIO2[30] */
	MX6PAD(EIM_DA5__GPIO_3_5),		/* GPIO3[5] */
#else
	MX6PAD(EIM_EB2__IPU2_CSI1_D_19),	/* GPIO2[30] */
	MX6PAD(EIM_DA5__IPU2_CSI1_D_4),		/* GPIO3[5] */
#endif
#if ( defined(CONFIG_MACH_MX6_NITROGEN6X_STERSEE6) || defined(CONFIG_MACH_MX6_NITROGEN6X_STERSEE6_LVDS) ) && !defined(FOR_DL_SOLO)
	MX6PAD(EIM_A24__IPU2_CSI1_D_19),	/* GPIO5[4] */
#else
...
static iomux_v3_cfg_t MX6NAME(lcd_pads_disable)[] = {
    ...
    defined(CONFIG_MXC_CAMERA_O7251_MIPI) || defined(CONFIG_MXC_CAMERA_OV7251_MIPI_MODULE) || \
